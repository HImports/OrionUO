...
const int MAX_ANIMATIONS_OBJECT_REMOVED_BY_GAGE_COLLECTOR = 5;

const int MAX_ART_OBJECT_REMOVED_BY_GAGE_COLLECTOR = 20;

const int MAX_GUMP_OBJECT_REMOVED_BY_GAGE_COLLECTOR = 20;

const int MAX_SOUND_OBJECT_REMOVED_BY_GAGE_COLLECTOR = 20;

const int MAX_MAP_OBJECT_REMOVED_BY_GAGE_COLLECTOR = 50;
